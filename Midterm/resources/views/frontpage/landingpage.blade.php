                            ...
                            <div class="relative">
                                <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                                    <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:textgray400"
                                        ...
                                        <path fillrule="evenodd" cliprule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2
                                                2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0
                                                100-2H6z">
                                        </path>
                ...
                <section>
                    <div class="md:flex font-sans pt-8">
                        <div class="md:shrink-0">
                            <img src="https://palm-living.com/wp-content/uploads/2018/07/Tari-Kecak-1.jpg" alt=""
                                class="w-full md:h-full md:w-56 h-48 inset-0 object-cover rounded-lg" loading="lazy" />
                        </div>
                        <form class="p-6">
                    ...
                    <div class="md:flex font-sans pt-8">
                        <div class="md:shrink-0">
                            <img src="https://palm-living.com/wp-content/uploads/2018/07/Tari-Kecak-1.jpg" alt=""
                                class="w-full md:h-full h-48 md:w-56 inset-0 object-cover rounded-lg" loading="lazy" />
                        </div>
                        <form class="p-6">
                            <div class="flex flex-wrap">
                                <h1 class="flex-auto font-medium text-slate-900">
