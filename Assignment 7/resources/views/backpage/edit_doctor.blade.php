<x-backpage>
    <div class="w-full mt-5">
        ...
        <div class="bg-white overflow-auto">
            <div>
                <form action="/admin/update_doctor/{{ $data->id_doctor }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{-- @method('PUT') --}}
                        ...
                        <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                            <div class="col-span-6 sm:col-span-4">
                                <label for="doctor_name" class="block text-sm font-medium text-gray-700">Doctor
                                    Name</label>
                                <input value="{{ $data->doctor_name }}" type="text" name="doctor_name" id="doctor_name"
                            ...
                            <div class="col-span-6 sm:col-span-4">
                                ...
                                <input value="{{ $data->specialization }}" type="text" name="specialization" id="specialization"
                                    class="mt-1 block w-50 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input value="{{ $data->doctor_desc }}" id="doctor_desc" name="doctor_desc" type="text"
